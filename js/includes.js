window.addEventListener('load', function(){
    ...
    const navfooter_content = `
      ...
      <label class="open" for="pop-up"><p style="font-weight: bold;padding: 0rem 1rem;">QRコード</p></label><input type="checkbox" id="pop-up"><div class="overlay"><div class="popup_window"><label class="close" for="pop-up">×</label><img src="/NITAC_map/images/shareqr.png" style="width: 90%;" alt="シェアQR"></div></div>
